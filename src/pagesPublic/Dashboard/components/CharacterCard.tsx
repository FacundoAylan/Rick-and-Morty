...
export const CharacterCard = ({ character, onViewMore }: Props) => {
  ...
  return (
    ...
    ">
      ...
      <div className="w-80 h-40 relative flex items-center justify-center transition-transform duration-300 group-hover:scale-110">
        {/* Portal */}
        <img
          src="/image/portal.webp"
          alt="Portal gif"
          className="absolute top-0 left-0 w-full h-full z-0 transition-opacity duration-300"
        />
